...
def main():
    file_path = "/home/kali/test/test.txt"

    print("Original file content:")
    subprocess.run(["cat", file_path])
    print()

    print("Encrypting with XOR cipher...")
    ...
    print("Decrypting with XOR cipher...")
    ...
    print("Encrypting with RSA cipher...")
    ...
    print("Decrypting with RSA cipher...")
